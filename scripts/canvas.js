  ...
  space.add({
    animate: function (time, fps, context) {
      ...
      for (var i = 0; i < pts.length; i++) {
        ...
        form.stroke(false).fill(colors[i % 3]).point(pt, 20);

        // get line from pt to the mouse line
        var ln = new Line(0).to(line.getPerpendicularFromPoint(pt));
        ...
        var color = "rgba(0,0,0," + pts[i].brightness + ")"
